...
def createContext(location, contextsBook):
    ...
    global CONTEXT_SCENE_1, CONTEXT_SCENE_2, CONTEXT_SCENE_3, promptContext
...
def clearAnswer(generated_text, location, promptStory):
    global LOCATION_1, LOCATION_2, LOCATION_3
    global summary, doReset, call_number
...
def lambda_handler(event, _):
    global doReset, startTime, promptContext
    startTime = time.time()
