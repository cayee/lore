...
def lambda_handler(event, _):
    ...
    for vectorstore in vectorstores:
        ...
        CONTEXT_SCENE_1 = "Rookie is a new enforcer trainee in piltovian police force. Rookie meets Vi at the plaza in Piltover. Vi was ordered to go to the Ecliptic Vaults without Rookie and investigate the scene since someone broke into the vault a few hours ago."
